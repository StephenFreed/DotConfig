...
lsp.on_attach(function(client, bufnr)
  ...
  bind('n', '<C-h>', '<cmd>lua vim.lsp.buf.signature_help()<cr>')
  bind('n', '<C-1>', '<cmd>lua vim.lsp.buf.rename()<cr>')
  bind('n', '<C-2>', '<cmd>lua vim.lsp.buf.code_action()<cr>')
  bind('x', '<C-3>', '<cmd>lua vim.lsp.buf.range_code_action()<cr>')
